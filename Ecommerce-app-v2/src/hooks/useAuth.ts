...
export const useAuth = (): AuthState => {
  ...
  // Function to sign out the user and prevent race conditions with protected routes
  const logout = async () => {
  ...
  // isSigningOut: A boolean indicating if the user is currently signing out
  // logout: A function to sign out the user
  // updateUser: A function to update the user's profile data in Firestore and local state
  return { user, userProfile, loading, isSigningOut, logout, updateUser };
};
